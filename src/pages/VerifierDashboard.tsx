        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="card p-8 mb-8">
            ...
            <div className="space-y-4">
              {filteredCertificates.filter(c => c.verificationStatus === 'pending' && c.verifierRequest).map(certificate => (
                  <div key={certificate.id} className="card p-4 hover:shadow-lg transition-all duration-300">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-500">Requested by: {certificate.verifierRequest?.name} ({certificate.verifierRequest?.email})</p>
                      </div>
              ...
              {filteredCertificates.filter(c => c.verificationStatus === 'pending' && c.verifierRequest).length === 0 && (
